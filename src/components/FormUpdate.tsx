...
export default function FormUpdate({ isOpen, onClose, saveFormData, inputName, setInputName, inputValue, setInputValue, inputImage, setInputImage }: PropertyModalProps) {
      ...
      <div className="bg-white rounded-2xl shadow-xl w-[90%] max-w-md p-6 relative">
        ...
        <div className="flex flex-col gap-4">
          <input
            ...
            className="border-2 p-2 rounded-md border-gray-400 focus:outline-none focus:border-sky-500 text-black"
            type="text"
          ...
          <input
            ...
            className="border-2 border-gray-400 p-2 rounded-md focus:outline-none focus:border-sky-500 text-black"
            type="number"
          ...
          <button
            onClick={async () => await saveFormData()}
